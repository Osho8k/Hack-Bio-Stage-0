...
Kabir, M. A., et al. (2024). Python for Data Analytics: A Systematic Literature Review of Tools, Techniques, and Applications. Academic Journal on Science, Technology, Engineering & Mathematics Education, 4, 134-154.

Gandomi, A., et al. (2022). Machine Learning Technologies for Big Data Analytics. Electronics, 11(3), 421.

Sambasivan, R., et al. (2018). A Bayesian Perspective of Statistical Machine Learning for Big Data. arXiv, 1811.04788.

Luo, J., et al. (2016). Big Data Application in Biomedical Research and Health Care: A Literature Review. Biomedical Informatics Insights, 8, 1-10.
